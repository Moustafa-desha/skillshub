 ...
 @section('main')
			...
			<div class="row">
				...
				<div class="col-md-4">
					<div class="single-blog">
						<div class="blog-img">
							<a href="{{ url("exams/show/{$skill->id}") }}">
						...
						<div class="blog-meta">
							...
							<div class="pull-right">
								<span class="blog-meta-comments"><a href="#"><i class="fa fa-users"></i> {{ $skill->studentsCount() }}</a></span>
							</div>
						</div>
					</div>
				</div>
		...
		<div id="aside" class="col-md-3">
			...
			<div class="widget category-widget">
				<h3>{{ __('web.cats') }}</h3>
				@foreach ($allCats as $sidecat)
				<a class="category" href="{{ url('category/show/{$sidecat->id}') }}">{{ $sidecat->name() }} <span>{{ $sidecat->skills()->count() }}</span></a>	
				@endforeach
