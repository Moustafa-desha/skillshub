        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div id="main" class="col-md-9">
                    ...
                    <div>
                        {{-- هنا استخدمنا اف لتحقق من ان المستخدم مدخلش الامتحان قبل كدا وده باقى جزء التحق الى ف صفحه اكزام كنترولر --}}
                        @if($canViewStartBtn)
                ...
                <div id="aside" class="col-md-3">
                    ...
                    <ul class="list-group">
                        ...
                        <li class="list-group-item">{{ __('web.difficulty') }}: 
                            <!-- to make stars for exam difficulty we make for loop -->
